...
{
    ESP_LOGI(TAG,"esp_io_expander_new_i2c_tca9554: init new instance @ i2c base addr = 0x%lx", i2c_address);
...
static esp_err_t write_direction_reg(esp_io_expander_handle_t handle, uint32_t value)
{
    esp_io_expander_tca9554_t *tca9554 = (esp_io_expander_tca9554_t *)__containerof(handle, esp_io_expander_tca9554_t, base);
    value &= 0xff;
        ESP_LOGI(TAG,"write_direction_reg: i2c addr = 0x%lx", tca9554->i2c_address);
...
{
    esp_io_expander_tca9554_t *tca9554 = (esp_io_expander_tca9554_t *)__containerof(handle, esp_io_expander_tca9554_t, base);
        ESP_LOGI(TAG,"reset: i2c addr = 0x%lx", tca9554->i2c_address);

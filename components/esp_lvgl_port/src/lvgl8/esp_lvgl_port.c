...
{
    ESP_LOGI(TAG, "lvgl_port_init entry");
    ...
    if (cfg->task_affinity < 0) {
        ...
        ESP_LOGI(TAG, "Creating LVGL task, pinned to core %d", cfg->task_affinity);
...
err:
    ...
    ESP_LOGI(TAG, "lvgl_port_init exit");
    return ret;
}
...
static void lvgl_port_task(void *arg)
{
    ESP_LOGI(TAG, "lvgl_port_task entry");
    ...
    ESP_LOGI(TAG, "entering lvgl_port_task run loop");
    ...
    ESP_LOGI(TAG, "lvgl_port_task exit");
...
static void lvgl_port_task_deinit(void)
{
    ESP_LOGI(TAG, "lvgl_port_task_deinit");
...
static esp_err_t lvgl_port_tick_init(void)
{
    ESP_LOGI(TAG, "lvgl_port_tick_init");
